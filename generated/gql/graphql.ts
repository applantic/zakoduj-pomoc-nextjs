...
export type GetAllProductsQuery = { __typename?: 'Query', projects: Array<{ __typename?: 'Project', title: string, active: boolean, description: string, id: string, image: { __typename?: 'Asset', url: string, id: string } }> };
